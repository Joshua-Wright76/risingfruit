...
// Rendered at 80x80 (2x resolution) for crisp display on retina screens

// Icon size matches FruitIcons for consistent high-DPI rendering
const MARKER_ICON_SIZE = 80;

// Leaf icon (forager - edible plants)
export const leafIcon = `data:image/svg+xml,${encodeURIComponent(`
<svg xmlns="http://www.w3.org/2000/svg" width="${MARKER_ICON_SIZE}" height="${MARKER_ICON_SIZE}" viewBox="0 0 24 24" fill="#22c55e" stroke="#171717" stroke-width="1.5">
...
<svg xmlns="http://www.w3.org/2000/svg" width="${MARKER_ICON_SIZE}" height="${MARKER_ICON_SIZE}" viewBox="0 0 24 24" fill="#f59e0b" stroke="#171717" stroke-width="1.5">
...
<svg xmlns="http://www.w3.org/2000/svg" width="${MARKER_ICON_SIZE}" height="${MARKER_ICON_SIZE}" viewBox="0 0 24 24" fill="none" stroke="#a855f7" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
<svg xmlns="http://www.w3.org/2000/svg" width="${MARKER_ICON_SIZE}" height="${MARKER_ICON_SIZE}" viewBox="0 0 24 24" fill="#3b82f6" stroke="#171717" stroke-width="1.5">
...
<svg xmlns="http://www.w3.org/2000/svg" width="${MARKER_ICON_SIZE}" height="${MARKER_ICON_SIZE}" viewBox="0 0 24 24" fill="#f97316" stroke="#171717" stroke-width="1.5">
  <path d="M11 20A7 7 0 0 1 9.8 6.1C15.5 5 17 4.48 19 2c1 2 2 4.18 2 8 0 5.5-4.78 10-10 10Z"/>
  <path d="M2 21c0-3 1.85-5.36 5.08-6C9.5 14.52 12 13 13 12" fill="none"/>
</svg>
`)}`;
